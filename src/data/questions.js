export const QUESTIONS_DATABASE = [
  ...
  { id: 1, dimension: "El Ruido", text: "¿Qué ocurriría si la tecnología dejara de competir por tu atención y comenzara a entrenarla?" },
  { id: 2, dimension: "El Ruido", text: "¿Qué fue lo último que decidiste entrenar en tu vida que no pueda medirse?" },
  { id: 3, dimension: "El Ruido", text: "¿Cuántos segundos robaste hoy a tu atención sin intención?" },
  { id: 4, dimension: "El Ruido", text: "Describe el sonido de tu mente en este instante sin nombrarlo." },
  { id: 5, dimension: "El Ruido", text: "¿Qué notificación esperaste ansiosamente y qué dice eso de tu sed de validación?" },
  { id: 6, dimension: "El Ruido", text: "Si apagaras todas las pantallas durante 24 horas, ¿qué parte de tu identidad colapsaría primero?" },
  { id: 7, dimension: "El Ruido", text: "El ruido nunca fue el enemigo; el enemigo fue olvidar que existe el silencio. ¿Qué silencio olvidaste?" },
  { id: 8, dimension: "El Ruido", text: "¿En qué área de tu vida usás el 'estar ocupado' como anestésico emocional?" },
  { id: 9, dimension: "El Ruido", text: "La atención es el acto más profundo de respeto: ¿a qué entregaste la tuya hoy?" },
  { id: 10, dimension: "El Ruido", text: "¿Qué conversación postergaste hoy por miedo al vacío que genera la verdad?" },
  { id: 11, dimension: "El Ruido", text: "Aquello que recibe atención florece; lo que la pierde se desvanece. ¿Qué estás dejando morir?" },
  { id: 12, dimension: "El Ruido", text: "¿Qué estímulo digital de hoy consumiste solo para escapar del silencio?" },

  // --- DIMENSIÓN II: LA AUTOCONCIENCIA Y EL ESPEJO (13 a 24)
  { id: 13, dimension: "Autoconsciencia", text: "¿Quién observa tus pensamientos?" },
  { id: 14, dimension: "Autoconsciencia", text: "¿Cuánto de lo que llamás realidad es interpretación?" },
  { id: 15, dimension: "Autoconsciencia", text: "Elegí un pensamiento recurrente y decidí si merece convertirse en creencia." },
  { id: 16, dimension: "Autoconsciencia", text: "Mirá a una persona que te irrita. Separá los hechos de tus interpretaciones." },
  { id: 17, dimension: "Autoconsciencia", text: "Escribí dos columnas: 'Lo que digo valorar' y 'Lo que mi vida demuestra que valoro'." },
  { id: 18, dimension: "Autoconsciencia", text: "¿Qué hábito defendería tu identidad si mañana despertaras sin recordar quién sos?" },
  { id: 19, dimension: "Autoconsciencia", text: "Describe el silencio de anoche sin nombrarlo." },
  { id: 20, dimension: "Autoconsciencia", text: "¿Qué parte de tu personalidad elegiste realmente?" },
  { id: 21, dimension: "Autoconsciencia", text: "¿Cuántas de tus ambiciones nacieron de vos y cuántas fueron heredadas?" },
  { id: 22, dimension: "Autoconsciencia", text: "¿Qué parte de vos te da vergüenza y por eso la vigilás con más ferocidad?" },
  { id: 23, dimension: "Autoconsciencia", text: "La distancia entre tus valores y tus hábitos es el lugar exacto donde comienza tu entrenamiento. ¿Dónde está hoy?" },
  { id: 24, dimension: "Autoconsciencia", text: "¿Qué verdad sobre tu pasado seguís disfrazando de anécdota heroica?" },

  // --- DIMENSIÓN III: EL CUERPO Y EL ARRAIGO (25 a 36)
  { id: 25, dimension: "El Cuerpo y el Arraigo", text: "¿Dónde habitás realmente: en el pecho o en la cabeza?" },
  ...
  { id: 29, dimension: "El Cuerpo y el Arraigo", text: "¿Qué ritual cotidiano usás para no sentir el peso de estar vivo?" },
  ...
  { id: 32, dimension: "El Cuerpo y el Arraigo", text: "Si el ritmo de tu respiración dictara tu velocidad vital, ¿qué dejarías de perseguir?" },
  { id: 33, dimension: "El Cuerpo y el Arraigo", text: "¿Qué emoción estás almacenando en los hombros, la mandíbula o el estómago?" },
  { id: 34, dimension: "El Cuerpo y el Arraigo", text: "¿En qué momento del día tu cuerpo pidió descanso y vos le ordenaste continuar?" },
  { id: 35, dimension: "El Cuerpo y el Arraigo", text: "La materia es sabia y no se deja engañar por palabras. ¿Qué sensación evitás porque sabe demasiado a verdad?" },
  { id: 36, dimension: "El Cuerpo y el Arraigo", text: "Volvé al hueso, al músculo, a la respiración. ¿Qué te dice ahora?" },
  ...
  { id: 52, dimension: "Las Relaciones", text: "Elegí una persona que te irrite. Escribí tres hechos sobre ella y tres interpretaciones tuyas." },
  ...
  { id: 59, dimension: "Las Relaciones", text: "No intentés sentir por el otro; aprendé a estar con el otro. ¿Dónde te cuesta eso?" },
  ...
  { id: 74, dimension: "El Dinero y el Valor", text: "¿Cuánto de tu identidad está atado a lo que poseés o producís?" },
  ...
  { id: 83, dimension: "El Dinero y el Valor", text: "¿Cuánto de tu tiempo vale menos de lo que creés y por qué lo regalás así?" },
  ...
  { id: 119, dimension: "El Liderazgo", text: "¿Qué legado estás construyendo con las decisiones que tomás hoy?" },
  ...
  { id: 127, dimension: "Las Expectativas", text: "¿Qué fracaso temido seguís repitiendo en tu mente para justificar no intentar?" },
